...
class Solver(object):
    ...
    def train_segmentation_old(self, model, train_loader, val_loader, num_epochs=10, log_nth=0):
        """
        ...
        for epoch in range(num_epochs):
            ...
            for i, (inputs, targets) in enumerate(train_loader, 1):
                ...
                #print('shape of input batch after rearranging: %s' % str(inputs.squeeze(1).permute(1,0,2).float().shape))
                #print('shape of targets batch: %s' % str(targets.shape))
                #print('targets are : %s' % str(targets))
                #print('shape of outputs: %s' % str(outputs.shape))
            ...
            print('debug. shape of preds: %s'%str(preds.shape))
            print('debug. shape of targets: %s' % str(targets.shape))
